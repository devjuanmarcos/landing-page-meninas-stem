      ...
      >
        {theme == "light" ? (
          <FaSun
            width={4}
            height={4}
            className="text-primary p-1 rounded-full border border-var-background-claro bg-white w-full h-full"
          />
        ) : (
          <FaMoon
            width={4}
            height={4}
            className="text-primary dark:text-bg-marca100 p-1 rounded-full border border-var-background-claro bg-white  w-full h-full"
          />
        )}
      </div>
    </button>
